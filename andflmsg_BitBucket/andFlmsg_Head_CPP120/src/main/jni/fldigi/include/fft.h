...
public:
	...
	void resize(int n);
	void cdft(double *a);
//Android	void cdft(complex *a) { cdft( (double *) a); }
	void cdft(cmplx *a) { cdft( (double *) a); }
	void icdft(double *a);
//Android	void icdft(complex *a) { icdft( (double *) a); }
	void icdft(cmplx *a) { icdft( (double *) a); }
	void sifft(short int *siData, double *out);
//Android	void sifft(short int *siData, complex *a) { sifft(siData, (double *) a); }
	void sifft(short int *siData, cmplx *a) { sifft(siData, (double *) a); }
	void rdft(double *a);
//Android	void rdft(complex *a) { rdft( (double *) a); }
	void rdft(cmplx *a) { rdft( (double *) a); }
	void irdft(double *a);
//Android	void irdft(complex *a) { irdft( (double *) a); }
