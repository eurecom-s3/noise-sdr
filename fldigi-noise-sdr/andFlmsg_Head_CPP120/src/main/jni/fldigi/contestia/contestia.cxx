...
contestia::contestia(int omode)
{
	...
	progdefaults.contestiasmargin	= getPreferenceI("OLIVIASMARGIN", 8);
	progdefaults.contestiasinteg	= getPreferenceI("OLIVIASINTEG", 4);
	progdefaults.contestia_reset_fec  	= getPreferenceB("OLIVIARESETFEC", false);
