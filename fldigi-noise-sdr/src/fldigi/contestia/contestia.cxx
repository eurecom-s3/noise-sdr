...
contestia::contestia(int omode)
{
	...
	progdefaults.contestia_reset_fec  	= false; // getPreferenceB("OLIVIARESETFEC", false);
	//progdefaults.olivia8bit		  	= true; //getPreferenceB("OLIVIA8BIT", true);

	progdefaults.contestiasmargin = (int) clamp(progdefaults.oliviasmargin, 2.1, 128.1);
	progdefaults.contestiasinteg  = (int) clamp(progdefaults.oliviasinteg, 2.1, 128.1);
